...
#include<iostream>
using namespace std;
bool ReadXmlFile(const string fullPath="mytestXml.txt")
{//读取Xml文件，并遍历
    
        //string fullPath = "mytestXml.txt";
        //创建一个XML的文档对象。
		...
		//
		TiXmlElement *next=FirstPerson->NextSiblingElement();
		if(next)cout<<next->FirstChildElement()->FirstChild()->Value()<<endl;
		/*while(!next){
		}*/
